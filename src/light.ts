...
export const CreateShapeWithLight = async (
    ...
    li.specularIntensity = li.specularIntensity == undefined
        ? 0.4 : li.specularIntensity;
    ...
    if(isAnimation) {
        device.queue.writeBuffer(
            vertexUniformBuffer
            , 0
            , vp.viewProjectionMatrix as unknown as ArrayBuffer
        );
    ...
    function draw() {
        ...
        device.queue.writeBuffer(
            vertexUniformBuffer
            , 64
            , modelMatrix as unknown as ArrayBuffer
        );

        device.queue.writeBuffer(
            vertexUniformBuffer
            , 128
            , normalMatrix as unknown as ArrayBuffer
        );
